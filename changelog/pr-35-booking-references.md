...
- Gelöschte Buchungen werden per Soft-Delete ausgeblendet und behalten bei der Wiederherstellung dieselbe Buchungsnummer.
...
- `src/billing/migrations/0009_charge_soft_delete.py`
...
- Bestanden: `.venv/bin/python -m pytest` (`135 passed`)
- Bestanden: `.venv/bin/ruff check .`
- Bestanden: `.venv/bin/ruff format --check .`
- Bestanden: `graphify update .`
- Nicht ausgeführt: `npm run test:e2e` (System-Freigabe wegen Nutzungslimit abgelehnt)
