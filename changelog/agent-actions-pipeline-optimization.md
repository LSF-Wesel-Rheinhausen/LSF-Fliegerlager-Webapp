...
- `.venv/bin/python -m pytest` (623 bestanden)
...
- Playwright: Chromium (31 bestanden), Firefox (30 bestanden, 1 erwarteter Skip) und WebKit im
  gepinnten CI-Container (31 bestanden)
