...
- `ci.yml`: Fuehrt auf Pull Requests und Pushes nach `main` mit Python 3.13 und Node 22 den Django-Systemcheck, die vollstaendige Pytest-Suite sowie Playwright in Chromium, Firefox und WebKit aus. Pip-Downloads, installierte Node-Abhaengigkeiten und Browser-Binaries werden anhand der jeweiligen Lock-/Versionsschluessel gecacht; Systemabhaengigkeiten werden pro Lauf installiert.
