...
urlpatterns = [
    ...
    path(
        "participants/<int:participant_id>/charges/batch-delete/",
        views.charge_batch_delete,
        name="charge-batch-delete",
    ),
    ...
    path(
        "participants/<int:participant_id>/booking-logs/batch-restore/",
        views.booking_audit_batch_restore,
