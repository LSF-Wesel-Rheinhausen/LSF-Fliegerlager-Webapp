...
urlpatterns = [
    ...
    path("camps/<int:camp_id>/meals/", views.meal_overview, name="meal-overview"),
    path("meals/<int:signup_id>/cancel/", views.meal_signup_cancel, name="meal-signup-cancel"),
    path("meals/<int:signup_id>/restore/", views.meal_signup_restore, name="meal-signup-restore"),
